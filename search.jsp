    ...
    <body>
        ...
        <table>
           <tr>
            ...
            <tr>
                <td  colspan="2">
                    <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for names.." title="Type in a name" style="border: 1px solid black; width: 100%; font-size: 110%; padding: 12px 20px 12px 0px;">
                </td>
            </tr>
            <tr>
                <td colspan="2">
